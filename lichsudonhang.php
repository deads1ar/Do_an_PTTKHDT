...
<head>
    ...
    <link rel="stylesheet" href="css/lichsudh.css" type="text/css">
                                ...
                                if ($num_rows > 0) {
                                    foreach($result as $row){ ?>
                                        <tr>
                                            ...
                                            <td><?php echo number_format($row['TONG'],0,'','.');?> đ</td>
                                            <td><a href="chitietdonhang.php?IDDH=<?php echo $row['IDDH'];?>" class="btn-detail">Xem</a></td>
                                        </tr>
                                    <?php }
                                }
                                else 
                                echo '<td colspan="5"><h5>Bạn chưa có đơn hàng nào</h5></td>';
                                ?>
                            </tbody>
                        </table>
                    </div>
